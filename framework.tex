...
An always up-to-date overview of the configurations used for automated testing of pull requests against Trilinos can be found in the source code repository\footnote{\url{https://github.com/trilinos/Trilinos/blob/master/.github/workflows/AT2.yml}}.
