...
Contributions to Trilinos can be offered through the standard GitHub pull request model. Proposed code changes are required to pass a set of tests as well as review and approval prior to be merged. Detailed instructions can be found in the contributing guidelines\footnote{\url{https://github.com/trilinos/Trilinos/blob/master/CONTRIBUTING.md}} in the source code repository. Questions regarding the inclusion of new packages should be discussed with the Trilinos leadership team\footnote{\url{https://trilinos.github.io/team.html}}.
