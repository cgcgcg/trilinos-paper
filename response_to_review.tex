...
\Response{We used ``high-level'' to distinguish from lower level algorithms from sparse linear algebra and linear solvers. The distinction is not needed in this context and we removed both experssions, ``high-level'' and ``low-level''.}
