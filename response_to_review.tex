...
\Response{\todo{Is this true?}This capability of ROL is geared towards finite elements. To avoid confusion, we have update the text to clearly limit the scope to finite element methods.}
