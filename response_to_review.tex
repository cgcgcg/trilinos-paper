...
\Response{
  There is no publication that covers the batched BLAS routines in KokkosKernels.
  We have added reference~\cite{10.1145/3431921} that covers batched BLAS generally.
  We have replaced the term ``general capabilities'' with a listing of the types of algorithms that MueLu relies on.
}
