...
non-supernodal direct solver that relies on Block Triangular Form similar to KLU. It works even this structure is not present. However, it is not
...
\Response{This is Block Triangular Form. KLU (cite KLU https://dl.acm.org/doi/pdf/10.1145/1824801.1824814) also relies on BTF which was
originally inspired Gilbert and Peierls algorithm (https://epubs.siam.org/doi/10.1137/0909058). KLU is a pun instead of the abbreviation. It
