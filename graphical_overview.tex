...
\definecolor{colTum}{rgb}{0.0,0.396,0.741}
...
\node at (0,0) {\includegraphics[width=4.3cm]{logo_trilinos.png}};
...
\draw [fill=\colNonlinear!40,dashed] (0,3*\packageh+3*\dist) rectangle (\packagew, 4*\packageh+3*\dist) node [pos=0.5] {ROL};
