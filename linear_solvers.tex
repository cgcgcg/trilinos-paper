...
it natively implements the direct solver KLU2, it offers an uniform interface to third-party direct linear solvers such as CHOLMOD, MUMPS, Pardiso\_MKL, SuperLU, SuperLU\_MT, SuperLU\_Dist, and STRUMPACK, and it provides an interface to the on-node sparse direct solvers implemented in ShyLU.}
